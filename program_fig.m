...
names  ={'PBI','Consumo', 'Inversion','Empleo','Salario real','Tasa de interes','Capital','Gasto publico'};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
varble = {'y','c','innv','lab','w','r','kap','g'};
names  ={'PBI','Consumo', 'Inversi?n','Empleo','Salario real','Tasa de inter?s','Capital','Gasto p?blico'};
[nper,junk1] = size(y_e_z);
nvar = length(varble);
dates = (0:1:nper)';
